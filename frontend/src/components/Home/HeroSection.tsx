  ...
  return (
    <section className="hero" id="hero-section" ref={heroRef}>
      ...
      <motion.div
        ...
        animate="animate"
      >
        <motion.span className="hero-badge" variants={minimalItem}>
          <Square size={8} fill="currentColor" /> NEW COLLECTION
        </motion.span>

        <motion.h1 className="hero-title" variants={minimalItem}>
          TFI<span className="text-gradient">CLUB</span>
        </motion.h1>

        <motion.p className="hero-tagline" variants={minimalItem}>
          Be Your Own Style
        </motion.p>

        <motion.div className="hero-actions" variants={minimalItem}>
        ...
        <motion.div className="hero-trust-stats" variants={minimalItem}>
